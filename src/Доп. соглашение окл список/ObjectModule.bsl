...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	НоваяКоманда.Представление = НСтр("ru = 'ППФ Доп.соглашение оклад список'");
...
Функция ПолучитьДанныеПечати(МассивОбъектов) Экспорт
	...
	Пока Выборка.Следующий() Цикл 
		...
		ДобавитьПараметр(СоответствиеПараметров, "Организация", 			Выборка.ОрганизацияНаименованиеПолное);
		...
		ДобавитьПараметр(СоответствиеПараметров, "НомерДопСогл", 			Выборка.Комментарий);
...
Функция ДанныеДляПечатиТрудовогоДоговора(Сотрудник)
	...
	ЗапросПоПриемамНаРаботу.УстановитьПараметр("Сотрудник", Сотрудник);								   
	...
	Запрос.УстановитьПараметр("МассивПриемовНаРаботу", МассивПриемовНаРаботу);
	...
	Запрос.Текст =
		...
		|	Документ.ПриемНаРаботу КАК ПриемНаРаботу
		|ГДЕ
		|	ПриемНаРаботу.Ссылка В(&МассивПриемовНаРаботу)
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
