...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	НоваяКоманда.Представление = НСтр("ru = 'ППФ Доп.соглашение РКС'");
...
Функция ПолучитьДанныеПечати(МассивОбъектов) Экспорт
	...
	Если РК<>0 Тогда 
		РК = (РК - 1)*100;
	КонецЕсли;
	СН = ПолучитьНадбавку(Сотрудник, Справочники.ПоказателиРасчетаЗарплаты.СевернаяНадбавка, ДатаДоговора);
	ДопОтп = ПолучитьДопОтпуск(Сотрудник, КонецДня(ДатаДоговора));
