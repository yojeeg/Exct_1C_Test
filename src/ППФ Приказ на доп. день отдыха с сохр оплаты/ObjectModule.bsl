...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	МассивНазначений.Добавить("Документ.ОплатаПоСреднемуЗаработку");
	...
	ПараметрыРегистрации.Вставить("Наименование", " Приказ на дополнительный день отдыха "); //имя под которым обработка будет зарегестрирована в справочнике внешних обработок
	ПараметрыРегистрации.Вставить("Версия", "1.0");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
	ПараметрыРегистрации.Вставить("Информация", " Приказ на дополнительный день отдыха ");//так будет выглядеть описание печ.формы для пользователя
	ТаблицаКоманд = ПолучитьТаблицуКоманд();
	ДобавитьКоманду(ТаблицаКоманд, "ППФ Приказ на дополнительный день отдыха", "ПФ_MXL", "ВызовСерверногоМетода", Истина);
...
Функция ПолучитьДанныеДляПечати(Документ)
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	ОплатаПоСреднемуЗаработку.Организация.КодПоОКПО КАК КодПоОКПО,
	               |	ОплатаПоСреднемуЗаработку.Организация.НаименованиеПолное КАК НазваниеОрганизации,
	               ...
	               |	ОплатаПоСреднемуЗаработку.Сотрудник.Код КАК ТабельныйНомер,
