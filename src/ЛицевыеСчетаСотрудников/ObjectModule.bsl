		...
		Для каждого СтрокаПоГодам Из ДанныеОтчета.Строки Цикл
			...
			Для каждого СтрокаОрганизации Из СтрокаПоГодам.Строки Цикл
				...
				Если КлючВарианта = "Т54" Тогда
					...
					ВывестиСотрудниковПодразделенияТ54(СтрокаОрганизации.Строки, ДокументРезультат, Макет, ДополнительныеДанные, КонецПериода);					
...
Процедура ВывестиШапкуТ54(СтрокаСотрудника, ДокументРезультат, Макет)
	...
	Если ЗначениеЗаполнено(СтрокаСотрудника.Подразделение) Тогда
...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование", "Лицевые счета (Т-54) ППФ");
	ПараметрыРегистрации.Вставить("Версия", "1.0");
	ПараметрыРегистрации.Вставить("Информация", "Лицевые счета (Т-54) ППФ");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
	
	Команды = ТаблицаКоманд();
	ДобавитьКоманду(Команды, "Лицевые счета (Т-54) ППФ", "ЛицевыеСчетаТ54ППФ", "ОткрытиеФормы", Ложь, "");
