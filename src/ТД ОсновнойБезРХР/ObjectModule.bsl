...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	НоваяКоманда.Представление = НСтр("ru = 'ППФ ТД Основной без РХР (для Москвы)'");
	НоваяКоманда.Идентификатор = "ТД_ОсновнойБезРХРМосква";
...
Функция ДанныеДляПечатиТрудовогоДоговора(МассивОбъектов)
	...
	Пока Выборка.Следующий() Цикл
		...
		РезультатСклонения = "";
		Если НЕ ПараметрыТрудовогоДоговора.РуководительФИОПолные = Null Тогда			
