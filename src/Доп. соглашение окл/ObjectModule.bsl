...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	НоваяКоманда.Представление = НСтр("ru = 'ППФ Доп.соглашение оклад'");
	НоваяКоманда.Идентификатор = "ДопСоглашениеОклад";
...
Функция ПолучитьДанныеПечати(МассивОбъектов) Экспорт
	...
	Надбавки 		= "";
	ДатаДоговора 	= МассивОбъектов[0].Ссылка.ДатаНачала;
	ДатаНачРаботы 	= МассивДанныхЗаполнения[0].ТрудовойДоговорДата;
	Подразделение 	= МассивОбъектов[0].Ссылка.Подразделение;
	Должность 		= МассивОбъектов[0].Должность;
	...
	ДобавитьПараметр(СоответствиеПараметров, "Сумма", 					Формат(МассивОбъектов[0].СовокупнаяТарифнаяСтавка));
	ДобавитьПараметр(СоответствиеПараметров, "СуммаПрописью", 			ЧислоПрописью(МассивОбъектов[0].СовокупнаяТарифнаяСтавка, "НП=Ложь",",,,,,,,,0"));
	...
	ДобавитьПараметр(СоответствиеПараметров, "ДатаСДопСогл", 			Формат(МассивОбъектов[0].ДатаНачала, "ДЛФ=ДД"));
	ДобавитьПараметр(СоответствиеПараметров, "ДатаДопСогл", 			Формат(МассивОбъектов[0].Дата, "ДЛФ=ДД"));
	ДобавитьПараметр(СоответствиеПараметров, "НомерДопСогл", 			МассивОбъектов[0].Комментарий);
...
Функция ДанныеДляПечатиТрудовогоДоговора(МассивОбъектов)
	...
	ЗапросПоПриемамНаРаботу.УстановитьПараметр("Сотрудник",МассивОбъектов[0].Сотрудник);								   
