...
Процедура СформироватьПечатнуюФорму(Команда)
	...
	Печать("ЗаявлениеНаПереводК_Т5", ОбъектыНазначения.ВыгрузитьЗначения());
...
Процедура Печать(ИдентификаторКоманды, МассивДокументов) Экспорт
	...
	Для Каждого СтрокаДанных Из МакетИДанныеОбъекта Цикл 
		...
		Попытка 
			...
			ПечатьДокументаWord(СтрокаДанных, Ворд);
