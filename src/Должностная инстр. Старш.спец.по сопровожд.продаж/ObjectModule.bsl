...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	НоваяКоманда.Представление = НСтр("ru = 'ППФ Должностная инстр. Старш.спец.по сопровожд.продаж'");
	НоваяКоманда.Идентификатор = "ДолжностнаяИнстрСтаршСпецПоСопровождПродаж";
