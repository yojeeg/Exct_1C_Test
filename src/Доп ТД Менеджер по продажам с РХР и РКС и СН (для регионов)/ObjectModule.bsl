...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	НоваяКоманда.Представление = НСтр("ru = 'Доп/ТД Менеджер по продажам с РХР и РКС и СН (для регионов)'");
	НоваяКоманда.Идентификатор = "Доп_ТД_МенеджерПоПродажамРХРРКССНРегионы";
