...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	НоваяКоманда.Представление = НСтр("ru = 'ППФ Должностная инстр. Ведущ.спец.по сопровожд.продаж'");
	НоваяКоманда.Идентификатор = "ДолжностнаяИнстрВедущийСпецПоСопровождеПродаж";
