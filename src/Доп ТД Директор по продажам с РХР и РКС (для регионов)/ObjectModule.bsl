...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	НоваяКоманда.Представление = НСтр("ru = 'Доп/ТД Директор по продажам с РХР и РКС (для регионов)'");
	НоваяКоманда.Идентификатор = "Доп_ТД_ДиректорПоПродажамРХРРКСРегионы";
